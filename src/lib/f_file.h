...
#endif
Obdn_F_Primitive obdn_f_CreateFPrimFromRPrim(Obdn_Memory* memory, const Obdn_R_Primitive* rprim);
...
Obdn_R_Primitive obdn_f_CreateRPrimFromFPrim(Obdn_Memory* memory, const Obdn_F_Primitive *fprim);
Obdn_R_Primitive obdn_f_LoadRPrim(Obdn_Memory* memory, const char* filename, const bool transferToDevice);
